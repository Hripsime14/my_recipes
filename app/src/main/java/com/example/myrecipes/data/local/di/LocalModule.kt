...
import com.example.myrecipes.data.local.datasource.datasourceimpl.LoadRecipesLocalDataSourceImpl
...
val localModule = module {
    ...
    factory<LoadRecipesLocalDataSource> {
        LoadRecipesLocalDataSourceImpl(
            recipesDao = get()
        )
    }
}